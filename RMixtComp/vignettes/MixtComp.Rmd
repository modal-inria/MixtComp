...
Once a model learnt, one can use it to predict the clusters of new individuals.
...
The probabilities of belonging to the different class and the associated partition is given by:
``` {r}
tik <- getTik(resPred)
head(tik)
