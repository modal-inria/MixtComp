...
int main(int argc, char *argv[]) {
	...
	R.parseEvalQ(R"(setwd("/media/sf_Documents/160803 - debug MixtComp/180129 - Crashs Aléatoires - Etienne"))"); // note the use of string literals to avoid cluttering the R command with escape characters
