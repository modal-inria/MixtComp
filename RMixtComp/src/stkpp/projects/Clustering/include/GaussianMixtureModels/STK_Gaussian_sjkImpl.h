...
/** @file STK_Gaussian_sjkImpl.h
 *  @brief In this file we implement the randomInit and mStep methods for the Gaussian_sjk models.
 **/

#ifndef STK_GAUSSIAN_SJKIMPL_H
#define STK_GAUSSIAN_SJKIMPL_H
...
struct MixtureModelImpl< Array, Gaussian_sjk_Parameters >
{
  typedef DiagGaussianComponent<Array, Gaussian_sjk_Parameters> Component;
