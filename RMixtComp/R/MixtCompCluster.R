getMixtCompCluster <- function(nbTrialInInit, nbBurnInIter, nbIter, nbGibbsIter){
  # create a new Sem Strategy
  mcStrategy <- new("Strategy", "randomClassInit", nbTrialInInit, nbBurnInIter, nbIter, nbGibbsIter)
