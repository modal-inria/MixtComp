...
#' @importFrom ggplot2 ggplot aes ylim labs theme theme_minimal element_text element_blank geom_tile geom_text geom_bar scale_fill_gradient scale_fill_manual 
#'
#' @title RMixtComp
#' @docType package
