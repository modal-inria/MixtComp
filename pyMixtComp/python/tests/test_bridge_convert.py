...
class TestBridge(unittest.TestCase):
    def test_convert_C_matrix_convert_array(self):
        ...
        x = {
            "data": np.array([[1.73245393e-06], [1.49653391e-07]]),
            "rowNames": [],
            "colNames": [],
            "ctype": "Matrix",
            "dtype": "Real",
        ...
        x = {
            "data": np.array(
                [
                    [-2.02395103, -2.02395103, -2.02395103],
    ...
    def test_convert(self):
        ...
        expected_out["c"] = 2
        expected_out["d"] = {"dd1": {"ddd": 7}, "dd2": convert_c_vector(x["d"]["dd2"])}
    ...
    def test_convert_data_to_dict_with_dict(self):
        x = {"a": [1, 4], "b": [2, 5], "c": [3, 6]}
        expected_out = {"a": ["1", "4"], "b": ["2", "5"], "c": ["3", "6"]}
