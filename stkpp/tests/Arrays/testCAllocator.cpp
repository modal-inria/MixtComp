...
int Test( int M, int N, Range I, Range J, bool output)
{
    ...
    CAllocator<TYPE, Arrays::array2D_, UnknownSize, UnknownSize, Arrays::by_col_> B0(M, N);
    B0.setValue(9); print(B0, "B0");
    CAllocator<TYPE, Arrays::array2D_, 3, 4, Arrays::by_col_> B1(M, N);
    B1.setValue(9); print(B1, "B1");
    CAllocator<TYPE, Arrays::array2D_, UnknownSize, 4, Arrays::by_col_> B2(M, N);
    B2.setValue(9); print(B2, "B2");
    CAllocator<TYPE, Arrays::array2D_, 3, UnknownSize, Arrays::by_col_> B3(M, N);
    B3.setValue(9); print(B3, "B3");
    CAllocator<TYPE, Arrays::array2D_, UnknownSize, UnknownSize, Arrays::by_row_> B4(M, N);
    B4.setValue(9); print(B4, "B4");
    CAllocator<TYPE, Arrays::array2D_, 3, 4, Arrays::by_row_> B5(M, N);
    B5.setValue(9); print(B5, "B5");
    CAllocator<TYPE, Arrays::array2D_, UnknownSize, 4, Arrays::by_row_> B6(M, N);
    B6.setValue(9); print(B6, "B6");
    CAllocator<TYPE, Arrays::array2D_, 3, UnknownSize, Arrays::by_row_> B7(M, N);
    B7.setValue(9); print(B7, "B7");
    //
    stk_cout << _T("Test 8 constructors with size(M, N) and value.\n");
    CAllocator<TYPE, Arrays::array2D_, UnknownSize, UnknownSize, Arrays::by_col_> C0(M, N, 0);
    CAllocator<TYPE, Arrays::array2D_, 3, 4, Arrays::by_col_> C1(M, N, 1);
    CAllocator<TYPE, Arrays::array2D_, UnknownSize, 4, Arrays::by_col_> C2(M, N, 2);
    CAllocator<TYPE, Arrays::array2D_, 3, UnknownSize, Arrays::by_col_> C3(M, N, 3);
    CAllocator<TYPE, Arrays::array2D_, UnknownSize, UnknownSize, Arrays::by_row_> C4(M, N, 4);
    CAllocator<TYPE, Arrays::array2D_, 3, 4, Arrays::by_row_> C5(M, N, 5);
    CAllocator<TYPE, Arrays::array2D_, UnknownSize, 4, Arrays::by_row_> C6(M, N, 6);
    CAllocator<TYPE, Arrays::array2D_, 3, UnknownSize, Arrays::by_row_> C7(M, N, 7);
    //
    ...
    //
    stk_cout << _T("Test exchange and shift.\n");
    B0.exchange(C0); B1.exchange(C1);
    B2.exchange(C2); B3.exchange(C3);
    B4.exchange(C4); B5.exchange(C5);
    B6.exchange(C6); B7.exchange(C7);
    ...
    //
    stk_cout << _T("Test Bn.swap(Cn); B.realloc(M-1,N-1);\n");
    B0.exchange(C0); B1.exchange(C1);
    B2.exchange(C2); B3.exchange(C3);
    B4.exchange(C4); B5.exchange(C5);
    B6.exchange(C6); B7.exchange(C7);
