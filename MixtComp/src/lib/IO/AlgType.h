 ...
 * - Matrix<Real>
 */
typedef typename boost::variant<Index, Real, std::string, std::vector<std::string>, NamedVector<Real>, NamedVector<Index>, NamedVector<Integer>, NamedMatrix<Real>> AlgType;
