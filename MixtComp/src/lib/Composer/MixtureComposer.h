...
#ifndef LIB_COMPOSER_MIXTURECOMPOSER_H
#define LIB_COMPOSER_MIXTURECOMPOSER_H

#include <Composer/ClassDataStat.h>
#include <Composer/ClassSampler.h>
