...
CategoricalSampler::CategoricalSampler(const CategoricalSampler& sampler) :
...
CategoricalSamplerIterator CategoricalSampler::begin() const
{
  CategoricalSamplerIterator iterator(p_param_,
                                      p_zi_,
                                      pm_augDataij_->dataRanges_,
...
CategoricalSamplerIterator CategoricalSampler::end() const
{
  CategoricalSamplerIterator iterator(p_param_,
                                      p_zi_,
                                      pm_augDataij_->dataRanges_,
