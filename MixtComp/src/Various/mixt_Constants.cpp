...
const Real piThreshold = 0.05; //threshold on pi to detect degeneracy. Too high and classes are badly estimated, too low and individuals can not change class easily.
