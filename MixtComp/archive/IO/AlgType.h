 ...
 * - Matrix<Real>
 */
typedef typename boost::variant<Index, Integer, Real, std::string, std::vector<std::string>, NamedVector<Real>, NamedVector<Index>, NamedVector<Integer>, NamedMatrix<Real>> AlgType;
