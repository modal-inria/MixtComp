...
For *sd*, *stat* is a matrix with S*nClass rows. For a class $'k'$ and a subregression $'s'$, the parameter is the standard deviation the residuals of the regression. 
