...
```
  ...
  - **Rank_ISR** for ranking data. For a class $`k`$, the two parameters are the central rank ($`\mu_k`$) and the probability of making a wrong comparison ($`\pi_k`$). See the [article](https://hal.inria.fr/hal-00743384) for more details. 
