...
int TestGeneral( int M, int N, Range I, Range J, bool output)
{
    ...
    numbering(C0);  C0.row(2)[4]=8; C0.col(3)[4]=8;
    ...
    CArray<TYPE, Arrays::general_, 10, 12, Arrays::by_col_> C1(M, N, 1);
    numbering(C1); C1.row(2)[4]=8; C1.col(3)[4]=8;
    ...
    CArray<TYPE, Arrays::general_, UnknownSize, 12, Arrays::by_col_> C2(M, N, 2);
    numbering(C2); C2.row(2)[4]=8; C2.col(3)[4]=8;
    ...
    CArray<TYPE, Arrays::general_, 10, UnknownSize, Arrays::by_col_> C3(M, N, 3);
    numbering(C3); C3.row(2)[4]=8; C3.col(3)[4]=8;
    ...
    CArray<TYPE, Arrays::general_, UnknownSize, UnknownSize, Arrays::by_row_> C4(M, N, 4);
    numbering(C4); C4.row(2)[4]=8; C4.col(3)[4]=8;
    ...
    CArray<TYPE, Arrays::general_, 12, UnknownSize, Arrays::by_row_> C5(M, N, 5);
    numbering(C5); C5.row(2)[4]=8; C5.col(3)[4]=8;
    ...
    CArray<TYPE, Arrays::general_, UnknownSize, 12, Arrays::by_row_> C6(M, N, 6);
    numbering(C6); C6.row(2)[4]=8; C6.col(3)[4]=8;
    ...
    CArray<TYPE, Arrays::general_, 10, UnknownSize, Arrays::by_row_> C7(M, N, 7);
    numbering(C7); C7.row(2)[4]=8; C7.col(3)[4]=8;
...
int TestUpper( int M, int N, Range I, Range J, bool output)
{
    ...
    numbering(C0);  C0.row(2)[4]=8; C0.col(3)[2]=8;
    C0.sub(I, J).setValue(6); C0.elt(3, 4)=0;  C0.elt(M-1, N-1)=0;
    print(C0, "C0");
    stk_cout << "C0: Min Coeff =" << C0.minElt(row, col);
    stk_cout << "; pos=("<< row <<"," << col << ")\n" ;
    ...
    numbering(C1); C1.row(2)[4]=8; C1.col(3)[2]=8;
    C1.sub(I, J).setValue(6); C1.elt(3, 4)=0;  C1.elt(M-1, N-1)=0;
    print(C1, "C1");
    stk_cout << "C1: Min Coeff =" << C1.minElt(row, col);
    stk_cout << "; pos=("<< row <<"," << col << ")\n" ;
    ...
    numbering(C2); C2.row(2)[4]=8; C2.col(3)[2]=8;
    C2.sub(I, J).setValue(6); C2.elt(3, 4)=0;  C2.elt(M-1, N-1)=0;
    print(C2, "C2");
    stk_cout << "C2: Min Coeff =" << C2.minElt(row, col);
    stk_cout << "; pos=("<< row <<"," << col << ")\n" ;
    ...
    numbering(C3); C3.row(2)[4]=8; C3.col(3)[2]=8;
    C3.sub(I, J).setValue(6); C3.elt(3, 4)=0;  C3.elt(M-1, N-1)=0;
    print(C3, "C3");
    stk_cout << "C3: Min Coeff =" << C3.minElt(row, col);
    stk_cout << "; pos=("<< row <<"," << col << ")\n" ;
    ...
    numbering(C4); C4.row(2)[4]=8; C4.col(3)[2]=8;
    ...
    numbering(C5); C5.row(2)[4]=8; C5.col(3)[2]=8;
    C5.sub(I, J).setValue(6); C5.elt(3, 4)=0;  C5.elt(M-1, N-1)=0;
    print(C5, "C5");
    stk_cout << "C5: Min Coeff =" << C5.minElt(row, col);
    stk_cout << "; pos=("<< row <<"," << col << ")\n" ;
    ...
    numbering(C6); C6.row(2)[4]=8; C6.col(3)[2]=8;
    C6.sub(I, J).setValue(6); C6.elt(3, 4)=0;  C6.elt(M-1, N-1)=0;
    print(C6, "C6");
    stk_cout << "C6: Min Coeff =" << C6.minElt(row, col);
    stk_cout << "; pos=("<< row <<"," << col << ")\n" ;
    ...
    numbering(C7); C7.row(2)[4]=8; C7.col(3)[2]=8;
    C7.sub(I, J).setValue(6); C7.elt(3, 4)=0;  C7.elt(M-1, N-1)=0;
    print(C7, "C7");
    stk_cout << "C7: Min Coeff =" << C7.minElt(row, col);
    stk_cout << "; pos=("<< row <<"," << col << ")\n" ;
...
int TestPoint( int M, int N, Range I, Range J, bool output)
{
    ...
    numbering(C0);
    C0.sub(I).setValue(6); C0.elt(I.firstIdx())=M;  C0.elt(I.lastIdx())=M;
    print(C0, "C0");
    print(C0.transpose(), "C0.transpose()");
    stk_cout << "C0: Min Coeff =" << C0.minElt(row);
    stk_cout << "; pos= "<< row << "\n" ;
    stk_cout << "C0: Max Elt =" << maxElt(C0, row);
    stk_cout << "; pos= "<< row << "\n\n" ;
...
int TestVector( int M, int N, Range I, Range J, bool output)
{
    ...
    numbering(C0);
    C0.sub(J).setValue(6); C0.elt(J.firstIdx())=N;  C0.elt(I.lastIdx())=N;
    print(C0, "C0");
    print(C0.transpose(), "C0.transpose()");
    stk_cout << "C0: Min Coeff =" << minElt(C0, row);
    stk_cout << "; pos= "<< row  << "\n" ;
