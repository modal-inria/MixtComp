...
int main(int argc, char *argv[])
{
  try
  {
    ...
    Chrono::start();
    CArray<Real, Arrays::number_, 1, 1, Arrays::by_col_> res;
    res = p1*v1;
    Real eps = res - p3.sum();
    ...
    CArray<Real, Arrays::vector_, 202, 1> r10; r10 = 10.0;
    Chrono::start();
    res2 = blhs * d10;
    ...
    stk_cout << _T("+++++++++++++++++++++++++++++++++++++++++++++++++++++++\n");
    CArray<Real, Arrays::vector_, 22, 1> cv1(22, 0.01);
    CVectorX cres;
    Chrono::start();
    ...
    CArray<Real, Arrays::point_, 1, 202> pv1(22, 0.01);
    CArray<Real, Arrays::point_, 1, 22> pres;
    Chrono::start();
