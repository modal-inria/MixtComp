...
template< typename Functor> class UsedFunctor<Functor, 2>
...
struct EqualOp
{
  ...
  inline bool operator()(param1_type value1, param2_type value2) const
...
struct QuotientBaseOp<Type, false>
{
  ...
  inline Type operator() (Type a) const { return a * other_; }
  Type const other_;
};
...
struct AddOp
{
  ...
  inline Type operator() (param1_type a) const { return a + other_; }
