...
class Array1D : public IArray1D< Array1D<Type> >
{
  public:
    ...
    /** operator*= : multiply the container by a constant value.
     *  @param v the value
     **/
    inline Array1D& operator*=(Type const& v)
    {
    ...
    /** operator-= : substract to the container a constant value.
     *  @param v the value
     **/
    inline Array1D& operator-=(Type const& v)
    {
    ...
    /** operator/= : divide the container by a constant value.
     *  @param v the value
     **/
    inline Array1D& operator/=(Type const& v)
    {
