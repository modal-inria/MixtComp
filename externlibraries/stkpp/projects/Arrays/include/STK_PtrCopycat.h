...
struct BasedCopyCat<  Derived,  Rhs, Arrays::general_, Arrays::general_>
{
...
// general <- square
template < typename Derived, typename Rhs>
struct BasedCopyCat<  Derived,  Rhs, Arrays::general_, Arrays::square_>
{
  inline static void runByCol(Derived& lhs, Rhs const& rhs )
  {
...
// general <- diagonal
template < typename Derived, typename Rhs>
struct BasedCopyCat<  Derived,  Rhs, Arrays::general_, Arrays::diagonal_>
{
...
template < typename Derived, typename Rhs>
struct BasedCopyCat<  Derived,  Rhs, Arrays::general_,   Arrays::lower_triangular_>
{
  typedef typename hidden::Traits<Derived>::Type Type;
  inline static void runByCol(Derived& lhs, Rhs const& rhs )
  {
...
template < typename Derived, typename Rhs>
struct BasedCopyCat<  Derived,  Rhs, Arrays::general_, Arrays::upper_triangular_>
{
  typedef typename hidden::Traits<Derived>::Type Type;
  inline static void runByCol(Derived& lhs, Rhs const& rhs )
  {
...
// square <- general
template < typename Derived, typename Rhs>
struct BasedCopyCat<  Derived,  Rhs, Arrays::square_, Arrays::general_>
{
  inline static void runByCol(Derived& lhs, Rhs const& rhs )
  {
    for (int i= STKBASEARRAYS; i <= rhs.lastIdxRows(); ++i)
